        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                if (!empty($this->session->userdata('email'))) { ?>
                    ...
                    <a class="nav-item navlink" href="<?= base_url('member/logout'); ?>"><i class="fas fw fa-login"></i> Log out</a>
                <?php }  else { ?>
                    <a class="nav-item nav-link" data-toggle="modal" datatarget="#daftarModal" href="#"><i class="fas fw fa-login"></i> Daftar</a>
                    <a class="nav-item nav-link" data-toggle="modal" datatarget="#DaftarModal" href="#"><i class="fas fa-login"></i> Log in</a>
                <?php } ?>
